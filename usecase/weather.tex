...
\begin{figure}[htb]
\centering\includegraphics[width=0.8\textwidth]{usecase/nwp-arch.png}
\label{fig:weather-1}
\caption{WRF Modeling System Flow Chart with Various Configuration.} 
\end{figure}

\TODO{}{remove caption from within image \ref{fig:weather-1}}
...
\begin{figure}[htb]
\centering\includegraphics[width=0.6\textwidth]{usecase/weather.png}
\label{fig:weather-2}
