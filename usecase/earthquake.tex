...
use to forecast earthquakes into the future.
The application of models and hyper-parameter sets is an open challenge requiring a large amount of computational power and the investigation of several promising models.

As part of this effort a benchmark activity has been started within the MLCommons Science working Group \cite{las-2023-mlcommons-edu-eq}. The usecase deriving from this effort motivates our efforts. Figure \ref{fig:eq-general} shows the architecture of our current efforts which can be generalized to be applicable to many scientific analysis problems. 
