...
Reusability is an essential part for adaptation. To make it explicily
clear we adopt he well known FAIR principal \cite{??} but enhance them
first by focussing on analytics services, deployability and
operations. Togther we use the tern Analytics Service FAIR Principle (AS-FAIR-DO)}
