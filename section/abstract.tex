...
interactions while leveraging service collaboration, and service
cooperation.

This document focuses on expanding analytics services to
...
(b) a small motivation based on use cases with looked at, (c) enhancing
