...
NBD-PWG\footnote{\TODO{}{introduce in the background section}} is
exploring how to extend NBDIF \footnote{\TODO{}{introduce in the
background section}} for packaging scalable analytics as services to
meet the challenges of today’s information analytics. These services
are intended to be reusable, deployable, and operational for Big Data,
...
The initial focus of this document will address several key areas:
