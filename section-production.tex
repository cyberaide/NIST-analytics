...
\TODO{Gregor (The person that is supposed to fix it)}{The issue we observe}

\begin{verbatim}
\TODO{The person that is supposed to fix it}{The issue we observe}
\end{verbatim}

Todos will beintgrated in a list of todos that are included at the end of the document in an appendix

We also use comments that are not included in the todolist, but may serve as temprary visual aides to alert, highlight or anotate text. This includes \\
