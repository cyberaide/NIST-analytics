...
identification of relevant / appropriate analytics services, from the
registry.
...
\item[Multi factor Authentication in User Identity] A means for
  authenticating users via {\em }two or more types of
...
\item[Enhanced Analytics Service Registry.] Both public and private
  ...
  comparison to similar artefacts maintained / published in the
